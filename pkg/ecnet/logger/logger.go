// Package logger implements utility routines to initialize the logging facility used by ECNET components.
package logger
...
// AllowedLevels is the list of allowed log levels for ECNET Controller.
