(
  (
    ...
    ecnetRequestDurationHist = new stats.Histogram('ecnet_request_duration_ms', [
    ...
    identityCache = new algo.Cache(identity => (
      (
        ...
        items?.length === 4 ? ecnetRequestDurationHist.withLabels(namespace, kind, name, pod, items[0], items[1], items[2], items[3]) : null
      )
    )()),
