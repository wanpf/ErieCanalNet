...
# Script to generate client-go types and code for ECNET's CRDs
#
...
ROOT_PACKAGE="github.com/flomesh-io/ErieCanal"
...
function generate_client() {
  ...
  "${CODEGEN_PKG}"/generate-groups.sh all \
    "$ROOT_PACKAGE/pkg/ecnet/gen/client/$CUSTOM_RESOURCE_NAME" \
    "$ROOT_PACKAGE/pkg/ecnet/apis" \
